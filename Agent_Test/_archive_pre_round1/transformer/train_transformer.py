"""
Training Script — Transformer (Kareem JWEIA 2024)
===================================================
...
ROOT = Path(__file__).resolve().parent       # Agent_Test/transformer/
...
def main():
    ...
    model = TransformerForecaster(
        n_features=4, d_model=128, nhead=8,
        num_layers=3, dim_feedforward=256,
        dropout=0.1, horizon=HORIZON, seq_length=SEQ_LENGTH,
    ).to(DEVICE)
