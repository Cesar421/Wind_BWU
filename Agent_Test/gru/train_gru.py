"""
Training Script — Pure GRU
===========================
Round 1: single building (Alpha1_4 / 2_1_3) via --building.
Round 2+: all buildings (default).
"""

import sys
from pathlib import Path

ROOT = Path(__file__).resolve().parent       # Agent_Test/gru/
sys.path.insert(0, str(ROOT.parent))         # Agent_Test/
sys.path.insert(0, str(ROOT))                # gru/
...
from models.gru import PureGRU
